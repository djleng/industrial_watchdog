...
myAWSIoTMQTTShadowClient.configureCredentials("/raspi/cert/rootAmazonCA1.pem", "/raspi/cert/RaspberryPi-private.pem.key", "/raspi/cert/RaspberryPi-certificate.pem.crt")
